...
#define CONF_PRODUCT_ID 0x0322 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0001 /* 硬件版本 */
#define MANUFACTURER "Glab" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "NewHope64B" /* 硬件名词，用于蓝牙显示 */
...
static const uint8_t column_pin_array[MATRIX_COLS] = { 25, 26, 27, 28, 29, 30, 31, 12, 13, 14, 15, 16, 18, 19, 5 };
