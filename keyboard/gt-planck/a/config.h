...
#define CONF_PRODUCT_ID 0x031F /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0000 /* 硬件版本 */
#define MANUFACTURER "Glab" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "GT Planck_A" /* 硬件名词，用于蓝牙显示 */
...
#define MATRIX_COLS 9 /* 硬件阵列列数 */

/* key combination for command */
#define IS_COMMAND() ( \
    keyboard_report->mods == (MOD_BIT(KC_LSHIFT) | MOD_BIT(KC_RSHIFT)))

static const uint8_t row_pin_array[MATRIX_ROWS] = {3, 4, 26, 27, 28, 29, 30, 31};
static const uint8_t column_pin_array[MATRIX_COLS] = {3, 4, 26, 27, 28, 29, 30, 31, 25};
...
// 旋钮正向按钮映射
#define ROTARY_ENCODER_POS 0,0
// 旋钮负向按钮映射
#define ROTARY_ENCODER_NEG 1,1
// 独立旋钮按键  用于关机后开机
