...
#define PRODUCT "Omega50C" /* 硬件名词，用于蓝牙显示 */
...
#define RGB_MATRIX_CENTER { 104, 32 }
#define RGB_MATRIX_INDICATORS_CAPS 25
...
static const uint8_t row_pin_array[MATRIX_ROWS] = {10, 6, 5, 12, 24};
static const uint8_t column_pin_array[MATRIX_COLS] = {25, 26, 27, 28, 29, 30, 31, 4, 11, 16, 14, 15, 7};
