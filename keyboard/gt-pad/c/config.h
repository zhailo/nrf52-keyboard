...
#define PRODUCT "GT PAD_C" /* 硬件名词，用于蓝牙显示 */
...
static const uint8_t row_pin_array[MATRIX_ROWS] = {20, 18, 30, 25, 28};
static const uint8_t column_pin_array[MATRIX_COLS] = {12, 14, 15, 16, 99};
